...
function programpeaks() {
  ...
  act = ("trigger point saved at" + peakpoints + "type = " + comment);
...
var value = "0";
var dataa = [
   [user, time, bpm, pred, act]
];
function download_csv() {
    var csv = 'USER,TIME,BPM,PRED,ACT\n';
...
if (num.startsWith("appencsv")) { dataa.push([user,time,bpm,pred, act]); console.log("BIODATA LOGGED") }
