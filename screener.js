function programpeaks() {
  ...
  emailaddr = prompt("what is your email address to be notified when prerecorded reassurance buffer fails and intervention is required?");
  username = prompt("what is your email username?");
  password = prompt("what is your email password?");
...
if (num.startsWith("reassure")) { //CURRENTLY SET IN ARDUINO TO THRILL PEAK ONLY - ADD SEPARATE LOGIC FOR CALM MODE!
  var vidy = document.getElementById("videoPlayer");
...
var statuss = document.getElementsByClassName('statuss');
statuss[0].innerHTML = "jumped to reassuring clip";
console.log("peak") }

 if (num.startsWith("reassure")) {
 Email.send(emailaddr,
 emailaddr,
"Intervention Required - Distraught for too long",
"Visit mandatory. Increasingly distraught past buffer screener limit. Automated prerecorded reassurance failed.",
"smtp.gmail.com",
"username",
"password");
 }
